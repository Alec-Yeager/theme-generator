...
public:
    ...
    void setInitialMeansAndAssignments(std::vector<cv::Vec3b> initial_cluster_means,
    ...
    const std::vector<size_t> &getCurrentClusterAssignments() const { return current_cluster_assignments_; };
    const std::vector<size_t> &getInitialClusterAssignments() const { return initial_cluster_assignments_; };
